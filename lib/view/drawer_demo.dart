...
class HomepageDrawer extends StatelessWidget {
  ...
  Widget _listDrawer(BuildContext context, int index) {
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            trailing: Icon(Icons.local_phone, color: Colors.black12, size: 20.0),
          ),
          ListTile(
            title: Text('phone', textAlign: TextAlign.right),
            trailing: Icon(Icons.local_phone, color: Colors.black12, size: 20.0),
        ...
        padding: EdgeInsets.zero,
          children: [
            ...
            UserAccountsDrawerHeader(
              accountName: Text('vix, hi', style: TextStyle(fontWeight: FontWeight.bold)), 
              accountEmail: Text('hi_vix@163.com'),
              currentAccountPicture: CircleAvatar(
                backgroundImage: NetworkImage('https://avatars.githubusercontent.com/u/59596574?v=4'),
              ),
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  ...
                  colorFilter: ColorFilter.mode(
                    Colors.yellow[500].withOpacity(0.6), 
                    BlendMode.hardLight
                  ),
                ),
